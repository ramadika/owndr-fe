        ...
        <div className="mx-auto max-w-2xl text-center pt-8 pb-24">
          <hgroup>
            ...
            <p className="mt-2 text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Experience the freedom to explore with confidence.
            </p>
          </hgroup>
          <p className="mx-auto mt-6 max-w-xl text-pretty text-lg/8 text-gray-600">
            Join the conversation and see what everyone’s talking about. Explore
            the latest discussions, updates, and moments that matter.
          </p>
